    ...
    return (
        <Card className="py-4 m-auto" id="incident_card">
            ...
            <CardHeader className="pb-0 pt-2 px-4 flex-col ">
                ...
                <Chip className="mt-2" variant="flat" color="danger" radius="full" >{incidence.equipment}</Chip>
            ...
            <CardBody className="inline-block overflow-visible z-10">
                <div className=" grid grid-rows-2 grid-flow-col gap-y-3 gap-x-4 justify-center mt-3">
                    ...
                    <Chip color="secondary" variant="flat" radius="md">{incidence.category}</Chip>
                    <Chip color="warning" variant="flat" radius="md">{incidence.priority}</Chip>
                    <Chip color="success" variant="flat" radius="md">{incidence.status}</Chip>
                </div>

                <div className="flex items-end  mt-12">

                    <Button className="me-3 py-6" size="sm" radius="full" color="danger" variant="shadow" onClick={() => deleteIncidence(incidence.id)} type="submit"><svg aria-hidden="true" fill="none" stroke="currentColor"  width="24" strokeWidth="1.8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Button className=" py-6" size="sm" radius="full" color="warning" variant="shadow" onClick={() => navigate(`/edit?id=${incidence.id}`)} type="submit"><svg aria-hidden="true" fill="none" stroke="white" width="24" strokeWidth="1.8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
