  ...
  return (
    ...
    >
      {({ handleChange, handleSubmit, isSubmitting, values }) => (
        <Form className="capitalize flex justify-center items-center" onSubmit={handleSubmit}>

          <div id="form" className="bg-white shadow-lg  rounded-xl px-8 pt-6 pb-8 space-y-2  space-x-1">
            <h1 className="flex text-2xl justify-center">{queryId ? "Edit Incidence" : "Add Incidence"}</h1>
